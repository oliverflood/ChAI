...
def test(imports):
    ...
    c = torch.nn.Hardtanh()(torch.zeros(10) + 4.0)
    print(c)
    ...
    c = torch.nn.Hardtanh(min_val=-10.0)(torch.zeros(10) + 4.0)
    print(c)
    ...
    c = torch.nn.Hardtanh(max_val=10.0)(torch.zeros(10) + 4.0)
    print(c)
    ...
    c = torch.nn.Hardtanh(min_val=-50.0, max_val=30.0)(torch.zeros(10) + 4.0)
    print(c)