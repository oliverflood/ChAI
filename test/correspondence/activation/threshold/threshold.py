...
def test(imports):
    ...
    c = torch.nn.Threshold(threshold=-10.0)(torch.zeros(10) + 4.0)
    print(c)
    ...
    c = torch.nn.Threshold(value=10.0)(torch.zeros(10) + 4.0)
    print(c)
    ...
    c = torch.nn.Threshold(threshold=-50.0, value=30.0)(torch.zeros(10) + 4.0)
    print(c)