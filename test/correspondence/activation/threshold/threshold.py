...
def test(imports):
    ...
    b = torch.nn.Threshold()(torch.zeros(2,3,4) - 60.0)
    print(b)
    ...
    b = torch.nn.Threshold(threshold=-10.0)(torch.zeros(2,3,4) - 60.0)
    print(b)
    ...
    b = torch.nn.Threshold(value=10.0)(torch.zeros(2,3,4) - 60.0)
    print(b)
